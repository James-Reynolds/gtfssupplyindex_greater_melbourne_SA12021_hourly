...
si_by_area_and_hour_231010_rail_wider %>% filter(area_id == "20604150424") %>% select(1, 8:25)  %>% adorn_rounding(digits = 2) %>% kable(caption = "Victorian GTFS and Melbourne CBD SA1 zone 20604150424 (RMIT and State Library), hourly SI values for October 10, 2023, 6am to 11pm only" )
...
si_by_area_and_hour_231014_rail_wider %>% filter(area_id == "20604150424") %>% select(1, 8:25)  %>% adorn_rounding(digits = 2) %>% kable(caption = "Victorian GTFS and Melbourne CBD SA1 zone 20604150424 (RMIT and State Library), hourly SI values for October 14, 2023, 6am to 11pm only" )
