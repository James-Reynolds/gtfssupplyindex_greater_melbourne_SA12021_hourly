...
si_by_area_and_hour_231010_tram_wider %>% select(1, 6:25) %>% head() %>% adorn_rounding(digits = 0) %>% kable(caption = "Victorian GTFS and SA1 zones within the Greater Melbourne GCCSA, hourly SI values for October 10, 2023, tram only, first 6 SA1 zones, 4am to 11pm only" )
...
##Skip printing table
#si_by_area_and_hour_231014_tram_wider %>% select(1, 6:28) %>% head(n=75) %>% adorn_rounding(digits = 0) %>% kable(caption = "Victorian GTFS and SA1 zones within the Greater Melbourne GCCSA, hourly SI values for October 10, 2023, first 75 SA1 zones, 4am to 2am only" )
...
## Skip table
#si_by_area_and_hour_231015_tram_wider %>% select(1, 6:28) %>% head(n=75) %>% adorn_rounding(digits = 0) %>% kable(caption = "Victorian GTFS and SA1 zones within the Greater Melbourne GCCSA, hourly SI values for October 10, 2023, first 75 SA1 zones, 4am to 2am only" )
```
...
si_by_area_and_hour_231010_rail_wider %>% select(1, 6:25) %>% head() %>% adorn_rounding(digits = 0) %>% kable(caption = "Victorian GTFS and SA1 zones within the Greater Melbourne GCCSA, hourly SI values for October 10, 2023, rail only, first 6 SA1 zones, 4am to 11pm only" )
...
##Skip printing table
#si_by_area_and_hour_231014_rail_wider %>% select(1, 6:28) %>% head(n=75) %>% adorn_rounding(digits = 0) %>% kable(caption = "Victorian GTFS and SA1 zones within the Greater Melbourne GCCSA, hourly SI values for October 10, 2023, first 75 SA1 zones, 4am to 2am only" )
...
## Skip table
#si_by_area_and_hour_231015_rail_wider %>% select(1, 6:28) %>% head(n=75) %>% adorn_rounding(digits = 0) %>% kable(caption = "Victorian GTFS and SA1 zones within the Greater Melbourne GCCSA, hourly SI values for October 10, 2023, first 75 SA1 zones, 4am to 2am only" )
```
...
si_by_area_and_hour_231010_bus_wider %>% select(1, 6:25) %>% head() %>% adorn_rounding(digits = 0) %>% kable(caption = "Victorian GTFS and SA1 zones within the Greater Melbourne GCCSA, hourly SI values for October 10, 2023, bus only, first 6 SA1 zones, 4am to 11pm only" )
...
##Skip printing table
#si_by_area_and_hour_231014_bus_wider %>% select(1, 6:28) %>% head(n=75) %>% adorn_rounding(digits = 0) %>% kable(caption = "Victorian GTFS and SA1 zones within the Greater Melbourne GCCSA, hourly SI values for October 10, 2023, first 75 SA1 zones, 4am to 2am only" )
...
## Skip table
#si_by_area_and_hour_231015_bus_wider %>% select(1, 6:28) %>% head(n=75) %>% adorn_rounding(digits = 0) %>% kable(caption = "Victorian GTFS and SA1 zones within the Greater Melbourne GCCSA, hourly SI values for October 10, 2023, first 75 SA1 zones, 4am to 2am only" )
```
...
si_by_area_and_hour_231010_tram_wider %>% filter(area_id == "21201154812") %>% select(1, 8:25)  %>% adorn_rounding(digits = 2) %>% kable(caption = "Victorian GTFS and Lang Lang SA1 zone 21201154812, hourly SI values for October 10, 2023, 6am to 11pm only" )
...
si_by_area_and_hour_231010_tram_wider %>% filter(area_id == "20604150424") %>% select(1, 8:25)  %>% adorn_rounding(digits = 2) %>% kable(caption = "Victorian GTFS and Melbourne CBD SA1 zone 20604150424 (RMIT and State Library), hourly SI values for October 10, 2023, 6am to 11pm only" )
...
si_by_area_and_hour_231014_tram_wider %>% filter(area_id == "20604150424") %>% select(1, 8:25)  %>% adorn_rounding(digits = 2) %>% kable(caption = "Victorian GTFS and Melbourne CBD SA1 zone 20604150424 (RMIT and State Library), hourly SI values for October 14, 2023, 6am to 11pm only" )
...
si_by_area_and_hour_231015_tram_wider %>% filter(area_id == "20604150424") %>% select(1, 8:25)  %>% adorn_rounding(digits = 2) %>% kable(caption = "Victorian GTFS and Melbourne CBD SA1 zone 20604150424 (RMIT and State Library), hourly SI values for October 15, 2023, 6am to 11pm only" )
...
si_by_area_and_hour_231010_rail_wider %>% filter(area_id == "21201154812") %>% select(1, 8:25)  %>% adorn_rounding(digits = 2) %>% kable(caption = "Victorian GTFS and Lang Lang SA1 zone 21201154812, hourly SI values for October 10, 2023, 6am to 11pm only" )
...
si_by_area_and_hour_231010_rail_wider %>% filter(area_id == "20604150424") %>% select(1, 4:25)  %>% adorn_rounding(digits = 2) %>% kable(caption = "Victorian GTFS and Melbourne CBD SA1 zone 20604150424 (RMIT and State Library), hourly SI values for October 10, 2023, 6am to 11pm only" )
...
si_by_area_and_hour_231014_rail_wider %>% filter(area_id == "20604150424") %>% select(1, 4:25)  %>% adorn_rounding(digits = 2) %>% kable(caption = "Victorian GTFS and Melbourne CBD SA1 zone 20604150424 (RMIT and State Library), hourly SI values for October 14, 2023, 6am to 11pm only" )
...
si_by_area_and_hour_231015_rail_wider %>% filter(area_id == "20604150424") %>% select(1, 8:25)  %>% adorn_rounding(digits = 2) %>% kable(caption = "Victorian GTFS and Melbourne CBD SA1 zone 20604150424 (RMIT and State Library), hourly SI values for October 15, 2023, 6am to 11pm only" )
...
si_by_area_and_hour_231010_bus_wider %>% filter(area_id == "21201154812") %>% select(1, 8:25)  %>% adorn_rounding(digits = 2) %>% kable(caption = "Victorian GTFS and Lang Lang SA1 zone 21201154812, hourly SI values for October 10, 2023, 6am to 11pm only" )
...
si_by_area_and_hour_231010_bus_wider %>% filter(area_id == "20604150424") %>% select(1, 8:25)  %>% adorn_rounding(digits = 2) %>% kable(caption = "Victorian GTFS and Melbourne CBD SA1 zone 20604150424 (RMIT and State Library), hourly SI values for October 10, 2023, 6am to 11pm only" )
...
si_by_area_and_hour_231014_bus_wider %>% filter(area_id == "20604150424") %>% select(1, 8:25)  %>% adorn_rounding(digits = 2) %>% kable(caption = "Victorian GTFS and Melbourne CBD SA1 zone 20604150424 (RMIT and State Library), hourly SI values for October 14, 2023, 6am to 11pm only" )
...
si_by_area_and_hour_231015_bus_wider %>% filter(area_id == "20604150424") %>% select(1, 8:25)  %>% adorn_rounding(digits = 2) %>% kable(caption = "Victorian GTFS and Melbourne CBD SA1 zone 20604150424 (RMIT and State Library), hourly SI values for October 15, 2023, 6am to 11pm only" )
...
```{r fix_ptv_data_Victoria_231228, eval = FALSE, echo = FALSE}
##-----THIS CHUNK ONLY NEEDS TO BE RUN ONCE TO CREATE THE gtfs_duplicate_stops_removed.zip file-----HENCE EVAL = FALSE ABOVE
