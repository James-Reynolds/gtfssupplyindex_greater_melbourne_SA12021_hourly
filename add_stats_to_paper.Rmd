...
# Methods
Data was received from Graham in a series of excel files. 
These are reviewed and processed using the ggstatsplot package[@ggstatsplot2021]. 
...
```{r compare_rail_non_rail, fig.cap="Absolute difference in SI Score for rail and non-rail related trips", fig.fullwidth = FALSE, cache = FALSE, echo = FALSE, message=FALSE}
...
```
As shown above, there is a statistically significant difference in the absolute difference in SI Score between the rail and non-rail-related trips.


```{r scatterplot_all, fig.cap="Absolute difference in SI Score and trip distance, all trips", fig.fullwidth = TRUE, cache = FALSE, echo = FALSE, message = FALSE}
...
```{r scatterplot_non_rail_and_rail_related, fig.cap="Absolute difference in SI Score and trip distance, rail-related and non-rail-related trips", fig.fullwidth = FALSE, cache = FALSE, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r scatterplot_over_3km, fig.cap="Absolute difference in SI Score and trip distance, trips over 3kms", fig.fullwidth = TRUE, cache = FALSE, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r scatterplot_less_than_or_equal_3km, fig.cap="Absolute difference in SI Score and trip distance, trips less than or equal to 3kms", fig.fullwidth = TRUE, cache = FALSE, echo = FALSE, message = FALSE, warning = FALSE}
...
```
 ...
 As shown above, there are statistically significant relationships between trip distance and absolutie difference in SI score for trips less than or equal to 3kms, across all trips, non-rail-related trips and rail-related trips. 
...
Data is separated by SA1 (rows)

```{r Choropleth_Data_total_trip, fig.cap="Aggregate SI score and Total Trip Volume", fig.fullwidth = FALSE, cache = FALSE, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r Choropleth_Data_trip_density, fig.cap="Aggregate SI Score and Total Trip Volume Density", fig.fullwidth = FALSE, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r Choropleth_Data_rail_trip, fig.cap="Aggregate SI Score and Rail Related Trip Count", fig.fullwidth = FALSE, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r Probability_of_rail_connection, fig.cap="Aggregate SI Score and Probability of Rail Connection", fig.fullwidth = FALSE, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r trip_ends_versus_starts_at_railway, fig.cap="Comparing rates of station proximity at trip start and end points", fig.fullwidth = FALSE, echo = FALSE, message = FALSE, warning = FALSE }
...
The above indicates that there is no statistically significant difference between whether a trip starts at a station or not and whether it ends at a station or not. 

## Share of trips starting and/or ending at a station - weekends versus weekdays (Section 4.3.1)

```{r start_railway_weekends, fig.cap="Share of trips starting at a railway station, by day type", fig.fullwidth = FALSE, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r end_railway_weekends, fig.cap="Share of trips ending at a railway station, by day type", fig.fullwidth = FALSE, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r start_and_end_railway_weekends, fig.cap="Share of trips starting and ending at a railway station, by day type", fig.fullwidth = FALSE, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r railway_distance_weekends, fig.cap="Distance by day type, rail-related trips", fig.fullwidth = TRUE, echo = FALSE, message = FALSE, warning = FALSE}
...
```
As shown above, there are statistically significant relationships between trip distance and and whether it is a weekday or weekend across both the non-rail-related and rail-related trip groupings. 



```{r distance_by_weekends, fig.cap="Distance by day type, all trips", fig.fullwidth = FALSE, echo = FALSE, message = FALSE, warning = FALSE}
...
```
As shown above, there are also a statistically significant relationship between whether a trip distance and whether it is a weekday or weekend, across all trips

## Rail-related trips are the same length as non-rail-related trips (Draft paper Section 4.3.1)

```{r rail_related_length, fig.cap="Distance by trip type", fig.fullwidth = FALSE, echo = FALSE, message = FALSE, warning = FALSE}
...
## Fishermans Bend stands out (Draft paper Section 4.3.3)
Fishermans Bend (SA1 area 20605151104) is noted as having a different pattern, especially related to rail-related trips being a higher than might otherwise be expected.  In the below, this is explored further.


```{r fishermans_bend, fig.cap="Trip distance, Fishermans Bend vs non-Fishermans bend trips, rail-related trips", fig.fullwidth = TRUE, echo = FALSE, message = FALSE, warning = FALSE}
all_data$Fishermans <- ifelse(
  all_data$origin_sa1 == "20605151104",
  "Fishermans Bend-related trip",
  ifelse(
    all_data$destination_sa1 == "20605151104",
    "Fishermans Bend-related trip",
    "Not Fishermans Bend-related"))
...
```
As shown above, there is a statistically significant relationship trip distance and whether a trip is Fishermans Bend related, for both rail related and non-rail related trips. 


```{r fishermans_bend_all_distance, fig.cap="Trip distance, Fishermans Bend vs non-Fishermans bend trips, all trips", fig.fullwidth = FALSE, echo = FALSE, message = FALSE, warning = FALSE}
...
As shown above, there is also a statistically significant relationship trip distance and whether a trip is Fishermans Bend related across all trips. 


```{r bib, include=FALSE}
# create a bib file for the R packages used in this document
knitr::write_bib(c('base', 'rmarkdown', 'ggstatsplot'), file = 'skeleton.bib')
```
